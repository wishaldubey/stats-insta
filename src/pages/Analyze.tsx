        ...
        <div className="message-container">
            {messages.length > 0 ? (
                messages.map((msg, index) => (
                    <div
                        key={index}
                        className={`message-wrapper ${msg.sender_name === "You" ? "you" : "other"
                            }`}
                    >
                        <div
                            className={`message-bubble ${msg.sender_name === "You" ? "you" : "other"
                                }`}
                        >
    ...
    return (
        <div className="analyze-page">
            ...
            <Modal
                ...
                overlayClassName="how-to-modal-overlay"
                ariaHideApp={false}
            >
                ...
                <div className="modal-content">
                    ...
                    <ol className="modal-steps">
                        ...
                        <li>
                            Go to{" "}
                            <a href="https://stats-insta.vercel.app/" target="_blank" rel="noopener noreferrer">
                                stats-insta.vercel.app
                            </a>
                            .
                        </li>
                ...
                <div className="modal-footer">
                    <button onClick={closeModal} className="btn btn-primary modal-close-footer-btn">
                        Got it!
                    </button>
                </div>
            </Modal>
